...
const CreateFixedAccount = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("http://localhost:3001/accounts", {
      ...
      .then((res) => {
        // console.log("Fixed account opened successfully");
      ...
      <div className="main-container">
        {showAlert && (
          <Alert
            ...
            message="Fixed account opened successfully"
            redirectMsg="Redirecting to home page..."
          />
        )}

        <h2>Create Fixed Account</h2>
        <div className="create-account-card">
          <div className="fs-15">
            <p>
              To open a Fixed Account, please enter the details in the form.
...
export default CreateFixedAccount;
